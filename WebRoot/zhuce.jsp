	...
	function check(){
		...
		$.ajax({
			...
			success:function(data)
			{
				if(data=='yes')
				{
					$('#mima').removeAttr('disabled');
					var msg="<a href='#'><font color='green'>发送验证码</font></a>"
					$('#txt2').html(msg);
				}
				else
				{
				var msg="<font color='red'>该手机号已被注册</font>"
					$('#txt2').html(msg);
				}
			},
			error:function()
    ...
    <div class="register">
        <form id="bdyz">
            <div class="tel clearfix">
                <span>手机号</span>
                <input type="text" id="phone" onblur="check()" >
                <i id="txt2"></i>
            </div>
            <div class="tel clearfix">
                <span>验证码</span>
                <input type="text" disabled="disabled" id="mima"   >
            </div>
            <div class="tel clearfix">
                <span></span>
