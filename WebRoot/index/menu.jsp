...
<dl class="leftmenu">
	...
	<dd>
		...
		<ul class="menuson">
			...
			<li><cite></cite><a href="QueryIdle">闲置信息列表</a><i></i></li>
		</ul>    
	</dd>
	<!-- 一个模块结束 -->
	...
	<dd>
		...
		<ul class="menuson">
			...
			<li><cite></cite><a href="module_geren/updatepwd.jsp">修改密码</a><i></i></li>
		</ul>    
	</dd>
	<!-- 一个模块结束 -->
	...
	<dd>
		...
		<ul class="menuson">
			<li><cite></cite><a href="module_keyworkds/keywords.jsp">关键词列表</a><i></i></li>
		</ul>    
	</dd>
	<!-- 一个模块结束 -->
