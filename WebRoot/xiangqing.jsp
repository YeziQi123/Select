...
<body>
    ...
    <div class="xiangqing wrap clearfix">
        ...
        <div class="xiangqing_right fr">
            ...
            <a href="confirm.jsp" target="_blank" class="xingqing_buy">立即购买</a>
            <div class="danbao">
                    <div class="danbao_first"><img src="images/danbao.png" > 担保交易<span>由支付宝先行保管,验货OK再付款到卖家账户。</span></div>
                    <div><img src="images/jiaoyi.png" > 实名认证<span>经支付宝核实会员身份和银行账户信息,真实可靠。</span></div>                    
            </div>
        </div>
    </div>
