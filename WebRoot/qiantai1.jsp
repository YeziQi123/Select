    	...
    	success:function(data)
    		{
				...
				{
					str+=
				"<a href='SelectXiangqing?id="+data[i].id+"' target='_blank'>"+
				'<img style="width:150px;height:150px;" src="idleimg/'+data[i].idleimg+'" >'+
    	...
    	success:function(data)
    		{
				...
				{
					str+=
				"<li><a href='SelectXiangqing?id="+data[i].id+"' target='_blank'>"+
				'<img style="width:120px;height:120px;" src="idleimg/'+data[i].idleimg+'">'+
				"<br><span>"+data[i].name+"</span>"+
				"<br><span>¥"+data[i].transfer_price+"</span>"+"</a></li>"
				}$('#tb1').html(str);
				},
				error:function()
				{
    		...
    		if(uid == ''){
    			...
    			$.ajax({
    				...
    				success:function(data){
    					...
    					var jiaoyijilu = data[0].jiaoyijilu;
...
<body>
    ...
    <div class="header">
        <div class="header_main wrap">
            ...
            <ul class="header_menu clearfix">
                <li><a href="qiantai1.jsp" class="active">首页</a></li>
                <li><a href="list.jsp">手机二手</a></li>
                ...
                <li class="header_mycenter">
                    ...
                    <ul class="header_center">  
                        <li><a href="gerenxinxi.jsp">完善个人信息</a></li>  
                        <li><a href="updatePwd.jsp">修改密码</a></li>  
                        <li><a href="#">我的收藏</a></li>  
                    </ul> 
                </li>
                <li class="quit"><a href="ExitIndex">退出</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="section1 wrap clearfix">
        ...
        <div class="lunbo">
            ...
            <div class="lunbo_bd">
                <ul>
                    <li><a href="#" target="_blank"><img src="images/lunbo.jpg" /></a></li>
                    <li><a href="#" target="_blank"><img src="images/lunbo2.jpg" /></a></li>
                </ul>
            </div>
        ...
        <div class="personal">
            <div class="clearfix">
                <div class="personal_head"><img src="images/danhuang.png"></div>
                <p class="personal_hi"><a href="login.html" class="login" target="_blank"></a>${map.u_nickname}<br>这里有更多你感兴趣的！</p>
            </div>
            <div class="clearfix">
                <a href="login2.jsp" class="personal_login" target="_blank">登录</a>
                <a href="zhuce.jsp" class="personal_register" target="_blank">注册</a>
            </div>
    ...
    <div class="wrap like">
        ...
        <div class="tabbd">
            <div class="tabc clearfix" style="display:block;" id="tb" >
    ...
    <div class="section wrap">
        ...
        <div class="section_main clearfix">
            ...
            <div class="section_middle fl" style="display:block;" id="tb1"  >
